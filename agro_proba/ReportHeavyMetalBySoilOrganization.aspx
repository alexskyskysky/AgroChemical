<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportHeavyMetalBySoilOrganization.aspx.cs" Inherits="agro_proba.ReportHeavyMetalBySoilOrganization" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" ShowBackButton="False" ShowDocumentMapButton="False" ShowFindControls="False" ShowZoomControl="False" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="220mm" Width="310mm" ShowWaitControlCancelLink="False" ViewStateMode="Enabled" PromptAreaCollapsed="True" PageCountMode="Actual" ExportContentDisposition="AlwaysInline">
            <LocalReport ReportEmbeddedResource="agro_proba.HeavyMetalBySoilOrganization.rdlc" ReportPath="Reports\HeavyMetalBySoilOrganization.rdlc" DisplayName="GroupsByTypeFarmlandHM" EnableExternalImages="True" EnableHyperlinks="True">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="SelectHeavyMetalBySoilFromOrganization" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="agro_proba.ReportsDSTableAdapters.SelectHeavyMetalBySoilFromOrganizationTableAdapter" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:Parameter Name="id_organization" Type="Int32" />
                <asp:Parameter Name="tour" Type="Int32" />
            </SelectParameters>
