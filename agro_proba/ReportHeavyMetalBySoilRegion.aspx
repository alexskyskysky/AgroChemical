<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportHeavyMetalBySoilRegion.aspx.cs" Inherits="agro_proba.ReportHeavyMetalBySoilRegion" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" ShowBackButton="False" ShowDocumentMapButton="False" ShowFindControls="False" ShowZoomControl="False" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="220mm" Width="310mm" ShowWaitControlCancelLink="False" ViewStateMode="Enabled" PromptAreaCollapsed="True" PageCountMode="Actual" ExportContentDisposition="AlwaysInline">
            <LocalReport ReportEmbeddedResource="agro_proba.HeavyMetalBySoilRegion.rdlc" ReportPath="Reports\HeavyMetalBySoilRegion.rdlc" DisplayName="GroupsByTypeFarmlandHMRegion" EnableExternalImages="True" EnableHyperlinks="True">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="SelectHeavyMetalBySoilFromRegion" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="agro_proba.ReportsDSTableAdapters.SelectHeavyMetalBySoilFromRegionTableAdapter" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:Parameter Name="id_region" Type="Int32" />
                <asp:Parameter Name="tour" Type="Int32" />
            </SelectParameters>
