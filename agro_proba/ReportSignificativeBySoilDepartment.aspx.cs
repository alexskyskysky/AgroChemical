...
{
    public partial class ReportSignificativeBySoilDepartment : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectSignificativeBySoilFromDepartment", this.ObjectDataSource1));
        }
