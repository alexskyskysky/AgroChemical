...
{
    public partial class ReportSignificativeBySoilTerritory : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectSignificativeBySoilFromTerritory", this.ObjectDataSource1));
        }
