...
{
    public partial class ReportSignificativeBySoilRegion : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectSignificativeBySoilFromRegion", this.ObjectDataSource1));
        }
