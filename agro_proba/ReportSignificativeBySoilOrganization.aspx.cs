...
{
    public partial class ReportSignificativeBySoilOrganization : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectSignificativeBySoilFromOrganization", this.ObjectDataSource1));
        }
