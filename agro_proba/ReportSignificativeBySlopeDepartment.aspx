<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportSignificativeBySlopeDepartment.aspx.cs" Inherits="agro_proba.ReportSignificativeBySlopeDepartment" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" ShowBackButton="False" ShowDocumentMapButton="False" ShowFindControls="False" ShowZoomControl="False" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="220mm" Width="310mm" ShowWaitControlCancelLink="False" ViewStateMode="Enabled" PromptAreaCollapsed="True" ExportContentDisposition="AlwaysInline" PageCountMode="Actual">
            <LocalReport ReportEmbeddedResource="agro_proba.SignificativeBySlopeDepartment.rdlc" ReportPath="Reports\SignificativeBySlopeDepartment.rdlc" DisplayName="GroupsBySlopeFromDepartment" EnableExternalImages="True" EnableHyperlinks="True">
                <DataSources>
