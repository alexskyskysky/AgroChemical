<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_analys_HA.aspx.cs" Inherits="agro_proba.Report_analys_HA" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" ShowBackButton="False" ShowDocumentMapButton="False" ShowFindControls="False" ShowZoomControl="False" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="320mm" Width="240mm" ShowWaitControlCancelLink="False" ViewStateMode="Enabled" PromptAreaCollapsed="True" PageCountMode="Actual" ExportContentDisposition="AlwaysInline">
            <LocalReport ReportEmbeddedResource="agro_proba.AlalysReport_HA.rdlc" ReportPath="Reports\AlalysReport_HA.rdlc" DisplayName="AlalysReport_HA" EnableExternalImages="True" EnableHyperlinks="True">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="SelectAnalys_HA" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="agro_proba.ReportsDSTableAdapters.SelectAnalys_HATableAdapter" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
