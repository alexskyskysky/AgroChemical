...
{
    public partial class ReportHeavyMetalBySoilTerritory : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectHeavyMetalBySoilFromTerritory", this.ObjectDataSource1));
        }
