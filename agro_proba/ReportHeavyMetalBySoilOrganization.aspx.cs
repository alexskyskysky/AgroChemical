...
{
    public partial class ReportHeavyMetalBySoilOrganization : System.Web.UI.Page
    {
        ...
        void LocalReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            e.DataSources.Add(new ReportDataSource("SelectHeavyMetalBySoilFromOrganization", this.ObjectDataSource1));
        }
